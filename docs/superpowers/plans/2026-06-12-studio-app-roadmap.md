...
| 4 | Live Viewer | DOCX/TXT pagination, three viewer adapters (PDF / EPUB / HTML), reading_session lifecycle, heartbeat, reaper, marks, hotkeys, split view | `2026-06-12-phase-4-live-viewer.md` |
| 5 | Schedule & Calendar | `schedule_item` CRUD for manual rows, ICS poller, two studio lanes, [Start Session] resolution, JIT onboarding wizard | `2026-06-12-phase-5-schedule-calendar.md` |
| 6 | Sync & Backup | Snapshot job, marks.json mirror, cold-start recovery, sync status UI | `2026-06-12-phase-6-sync-backup.md` |
| 7 | Reports & Polish | Streamed CSV exports, exports cleanup, settings page, app.log rotation | `2026-06-12-phase-7-reports-polish.md` |
